...
public class RacingMovingRoundErrorTest extends StandardOutputAssertionTest {
    ...
    void 숫자_이외의_문자_입력받는경우_적절한_에러문구를_출력하는지_검증_RacingMovingNumber_test() {
        assertGetRacingMovingNumberPrintProperErrorMessage(ERROR_MSG_PREFIX + ERROR_MSG_SHOULD_BE_ENTERED_ONLY_NUMBER, "!@#!@", "5");
    }
    ...
    void _1보다_작은_값을_입력받는경우_적절한_에러문구를_출력하는지_검증_RacingMovingNumber_test() {
        assertGetRacingMovingNumberPrintProperErrorMessage(ERROR_MSG_PREFIX + ERROR_MSG_SHOULD_BE_ENTERED_BIGGER_THAN_0, "0", "1");
    }
